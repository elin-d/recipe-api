...
def build_commentor_agent(llm=None):
    ...
    "- Once you have asked for all the needed information, write a good ~100-120 word review in markdown format detailing: \n"
    ...
    "Try to keep answer short and concise."
    "Once you gather the requested info, you MUST hand control back to the ReviewAndPostingAgent."
    )
...
def build_posting_agent(llm=None):
    ...
    "- The review must: \n"
    "- Be a ~100-150 word review in markdown format. \n"
